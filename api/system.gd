...
func _enter_tree() -> void:
	...
	DSXServer.connect_to_host("127.0.0.1",6971)

func _exit_tree() -> void:
	reset_settings(0)

func _ready() -> void:
	led(0, Color(0.733, 0.0, 0.537, 1.0),10)
...
#func adaptive_trigger(device: int, trigger: DSXRef.Trigger) -> void:
	#send_data({"type":DSXRef.InstructionType.TriggerUpdate,"parameters":[device,trigger,22,2,6,8]})
